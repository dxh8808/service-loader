...
public class AutoServiceProcesssor extends AbstractProcessor {
    ...
    private Multimap<TypeElement, TypeElement> elementProviders = HashMultimap.create();
    ...
    public ImmutableSet<String> getSupportedAnnotationTypes() {
        return ImmutableSet.of(Service.class.getName());
    }
    ...
    /**
     * <ol>
     * <li> For each class annotated with {@link Service}<ul>
     * <li> Verify the {@link Service} interface value is correct
     * <li> Categorize the class by its service interface
     * </ul>
     * <p>
     * <li> For each {@link Service} interface <ul>
     * <li> Create a file named {@code META-INF/services/<interface>}
     * <li> For each {@link Service} annotated class for this interface <ul>
    ...
    private void processAnnotations(Set<? extends TypeElement> annotations,
        ...
        for (Element e : elements) {
            ...
            AnnotationMirror annotationMirror = getAnnotationMirror(e, Service.class).get();
            ...
            for (DeclaredType providerInterface : providerInterfaces) {
                ...
                if (checkImplementer(providerImplementer, providerType)) {
                    ...
                    elementProviders.put(providerType, providerImplementer);
                } else {
...
//        JavaFile javaFile = ServicePoolGenerator.process(elementProviders);
//        try {
